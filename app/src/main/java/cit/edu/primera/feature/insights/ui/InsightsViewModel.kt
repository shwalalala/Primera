package cit.edu.primera.feature.insights.ui
...
import cit.edu.primera.core.util.DataExportHelper
...
class InsightsViewModel(
    ...
    private val networkMonitor: cit.edu.primera.core.util.NetworkMonitor
) : ViewModel() {
    ...
    val uiState: StateFlow<InsightsUiState> = combine(
        ...
        val dashboardData = args[0] as cit.edu.primera.feature.dashboard.domain.DashboardData?
        val logs = args[1] as List<cit.edu.primera.feature.checkins.data.CheckinLogDto>
        val weightData = args[2] as cit.edu.primera.feature.checkins.data.CheckinUserDto?
        val goals = args[3] as List<cit.edu.primera.feature.goals.data.GoalDto>
        val healthRecords = args[4] as List<cit.edu.primera.feature.smartwatchconnection.domain.SmartwatchHealth>
    ...
    private fun generateHealthWarning(logs: List<cit.edu.primera.feature.checkins.data.CheckinLogDto>, period: String): String? {
    ...
    private fun filterGoalsByPeriod(goals: List<cit.edu.primera.feature.goals.data.GoalDto>, period: String, offset: Int): List<cit.edu.primera.feature.goals.data.GoalDto> {
    ...
    private fun filterLogsByPeriod(logs: List<cit.edu.primera.feature.checkins.data.CheckinLogDto>, period: String, offset: Int): List<cit.edu.primera.feature.checkins.data.CheckinLogDto> {
        val calendar = Calendar.getInstance()
        applyOffset(calendar, period, offset)
        val targetDate = calendar.time
    ...
    private fun calculateCheckinOffset(logs: List<cit.edu.primera.feature.checkins.data.CheckinLogDto>): Float {
    ...
    private fun calculateSmartwatchContribution(records: List<cit.edu.primera.feature.smartwatchconnection.domain.SmartwatchHealth>, period: String): Float {
    ...
    private fun extractSmartwatchValues(
        records: List<cit.edu.primera.feature.smartwatchconnection.domain.SmartwatchHealth>,
        period: String,
        offset: Int,
        extractor: (cit.edu.primera.feature.smartwatchconnection.domain.SmartwatchHealth) -> Float
    ): List<Float> {
        val calendar = Calendar.getInstance()
        applyOffset(calendar, period, offset)
    ...
    private fun extractWeightValues(logs: List<cit.edu.primera.feature.checkins.data.CheckinLogDto>, latestWeight: Float): List<Float> {
    ...
    private fun extractMoodValues(logs: List<cit.edu.primera.feature.checkins.data.CheckinLogDto>): List<Float> {
        return logs.map { log ->
    ...
    private fun calculateLongitudinalInsights(
        records: List<cit.edu.primera.feature.smartwatchconnection.domain.SmartwatchHealth>,
        logs: List<cit.edu.primera.feature.checkins.data.CheckinLogDto>
    ): List<String> {
